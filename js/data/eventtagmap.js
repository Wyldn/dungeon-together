...
export const EVENT_TAG_MAP = {
  ...
  evil_wizard_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  evil_wizard_3_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  archer_hero_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  samurai_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  rogue_hero_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  tr_live_wizard_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  fantasy_warrior_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  huntress_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  huntress_2_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  martial_hero_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  martial_hero_2_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
  martial_hero_3_meet: ['npc-duel', 'combat-threat', 'equipment', 'mentor'],
