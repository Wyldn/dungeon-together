...
export const ENEMIES = {
  forest: [
    { id: 'wolf', name: 'Dire Wolf', glyph: '🐺', hp: 21, atk: 6, def: 1, spd: 9, gold: [6, 14], xp: 10, pack: true },
    { id: 'sprite', name: 'Feral Sprite', glyph: '🧚', hp: 15, atk: 5, def: 0, spd: 12, gold: [8, 16], xp: 9, caster: true, intelligent: true },
    { id: 'boar', name: 'Ironback Boar', glyph: '🐗', hp: 32, atk: 7, def: 2, spd: 5, gold: [7, 15], xp: 12 },
    { id: 'bandit', name: 'Forest Bandit', glyph: '🗡️', hp: 25, atk: 7, def: 1, spd: 8, gold: [14, 28], xp: 12, pack: true, intelligent: true },
    { id: 'treant', name: 'Young Treant', glyph: '🌳', hp: 45, atk: 8, def: 4, spd: 3, gold: [10, 20], xp: 16, elite: true },
    { id: 'spider', name: 'Widow Spider', glyph: '🕷️', hp: 19, atk: 6, def: 1, spd: 10, gold: [6, 13], xp: 10, poison: 0.4 },
  ],
  ruins: [
    ...
    { id: 'acolyte', name: 'Hollow Acolyte', glyph: '🕯️', hp: 32, atk: 12, def: 2, spd: 8, gold: [14, 26], xp: 16, caster: true, intelligent: true },
  ],
  frost: [
    { id: 'wraith', name: 'Ice Wraith', glyph: '❄️', hp: 44, atk: 14, def: 4, spd: 10, gold: [16, 30], xp: 20, freeze: 0.3 },
    { id: 'frost_giant', name: 'Frost Giant', glyph: '🧊', hp: 88, atk: 16, def: 8, spd: 3, gold: [26, 44], xp: 30, elite: true, intelligent: true },
  ...
  swamp: [
    { id: 'hag', name: 'Mire Hag', glyph: '🧙', hp: 58, atk: 19, def: 5, spd: 8, gold: [24, 42], xp: 30, caster: true, sanityHit: 4, intelligent: true },
    ...
    { id: 'troll', name: 'Moss Troll', glyph: '👹', hp: 110, atk: 20, def: 9, spd: 3, gold: [30, 52], xp: 38, elite: true, regen: 0.06, intelligent: true },
  ],
  hell: [
    { id: 'imp', name: 'Cinder Imp', glyph: '👺', hp: 60, atk: 23, def: 5, spd: 12, gold: [26, 46], xp: 34, pack: true, burn: 0.3, intelligent: true },
    { id: 'hellhound', name: 'Hellhound', glyph: '🐕‍🦺', hp: 76, atk: 26, def: 6, spd: 11, gold: [28, 48], xp: 38, pack: true, burn: 0.35 },
    { id: 'tormentor', name: 'Chain Tormentor', glyph: '⛓️', hp: 96, atk: 27, def: 9, spd: 6, gold: [34, 56], xp: 44, elite: true, sanityHit: 5, intelligent: true },
    { id: 'pit_mage', name: 'Pit Magus', glyph: '🔮', hp: 70, atk: 29, def: 5, spd: 9, gold: [32, 54], xp: 42, caster: true, burn: 0.4, intelligent: true },
