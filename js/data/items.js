...
export const WEAPONS = [
  ...
  { id: 'storm_bow', name: 'Stormcaller Bow', slot: 'weapon', wtype: 'bow', rarity: 'rare', tier: 3, atk: 5, dex: 3, crit: 8, weaken: 0.12, desc: 'Bow · +5 damage, +3 DEX, +8% crit, 12% weaken.', price: 175 },
  { id: 'sun_mace', name: 'Morning Benediction', slot: 'weapon', wtype: 'mace', rarity: 'rare', tier: 3, atk: 6, wis: 3, frail: 0.15, desc: 'Mace · +6 damage, +3 WIS, 15% frail on hit. Warm to the touch.', price: 170 },
  { id: 'void_scepter', name: 'Void Scepter', slot: 'weapon', wtype: 'staff', rarity: 'epic', tier: 4, atk: 8, int: 5, lifesteal: 0.15, weaken: 0.2, desc: 'Staff · +8 damage, +5 INT, 15% lifesteal, 20% weaken.', price: 300 },
  { id: 'dragonfang', name: 'Dragonfang Greatsword', slot: 'weapon', wtype: 'sword', rarity: 'epic', tier: 4, atk: 11, str: 3, burn: 0.18, desc: 'Sword · +11 damage, +3 STR, 18% burn. Still warm.', price: 320 },
  { id: 'comet_wraps', name: 'Comet-Trail Wraps', slot: 'weapon', wtype: 'fist', rarity: 'epic', tier: 4, atk: 9, dex: 4, initiative: 2, weaken: 0.15, desc: 'Fist · +9 damage, +4 DEX, faster initiative, 15% weaken.', price: 310 },
  ...
  { id: 'assassins_kiss', name: 'Assassin\'s Kiss', slot: 'weapon', wtype: 'dagger', rarity: 'rare', tier: 3, atk: 4, crit: 12, lifesteal: 0.08, poison: 0.15, desc: 'Dagger · +4 damage, +12% crit, 8% lifesteal, 15% poison.', price: 180 },
  { id: 'warhammer', name: 'Sunken Warhammer', slot: 'weapon', wtype: 'mace', rarity: 'rare', tier: 4, atk: 8, str: 3, wis: 1, frail: 0.12, desc: 'Mace · +8 damage, +3 STR, +1 WIS, 12% frail.', price: 210 },
  ...
  { id: 'infernal_lash', name: 'Infernal Lash', slot: 'weapon', wtype: 'dagger', rarity: 'epic', tier: 5, atk: 10, dex: 4, burn: 0.2, frail: 0.12, desc: 'Dagger · +10 damage, +4 DEX, 20% burn, 12% frail.', price: 340 },
  { id: 'titan_maul', name: 'Titan\'s Maul', slot: 'weapon', wtype: 'mace', rarity: 'epic', tier: 5, atk: 13, str: 5, frail: 0.2, desc: 'Mace · +13 damage, +5 STR, 20% frail. Swings like a verdict.', price: 350 },
  ...
  { id: 'raider_hatchet', name: 'Raider\'s Hatchet', slot: 'weapon', wtype: 'axe', rarity: 'rare', tier: 3, atk: 7, str: 2, crit: 5, weaken: 0.12, desc: 'Axe · +7 damage, +2 STR, +5% crit, 12% weaken.', price: 165 },
  { id: 'executioner_axe', name: 'Tower Executioner', slot: 'weapon', wtype: 'axe', rarity: 'epic', tier: 4, atk: 11, str: 4, crit: 6, frail: 0.18, desc: 'Axe · +11 damage, +4 STR, +6% crit, 18% frail. Still smells of paperwork.', price: 310 },
  { id: 'judge_gavel', name: 'Judge\'s Gavel', slot: 'weapon', wtype: 'mace', rarity: 'rare', tier: 3, atk: 6, wis: 2, str: 2, frail: 0.12, desc: 'Mace · +6 damage, +2 WIS, +2 STR, 12% frail. Sentences are optional.', price: 170 },
  ...
  { id: 'thornknife', name: 'Thornknife', slot: 'weapon', wtype: 'dagger', rarity: 'rare', tier: 3, atk: 4, dex: 3, crit: 7, poison: 0.18, desc: 'Dagger · +4 damage, +3 DEX, +7% crit, 18% poison. Barbed for keeping.', price: 160 },
  { id: 'skyneedle', name: 'Skyneedle Bow', slot: 'weapon', wtype: 'bow', rarity: 'epic', tier: 4, atk: 8, dex: 5, crit: 10, weaken: 0.18, desc: 'Bow · +8 damage, +5 DEX, +10% crit, 18% weaken. Arrows forget gravity.', price: 320 },
  { id: 'smokeknife', name: 'Smokeknife', slot: 'weapon', wtype: 'dagger', rarity: 'rare', tier: 3, atk: 4, dodge: 5, crit: 8, poison: 0.12, desc: 'Dagger · +4 damage, +5% dodge, +8% crit, 12% poison.', price: 170 },
  ...
  { id: 'grave_spike', name: 'Grave Spike', slot: 'weapon', wtype: 'staff', rarity: 'rare', tier: 3, atk: 5, int: 3, lifesteal: 0.08, weaken: 0.12, desc: 'Staff · +5 damage, +3 INT, 8% lifesteal, 12% weaken. Cold as a nameplate.', price: 180 },
  // ---- event-exclusive gear (never in random loot / shops) ----
  { id: 'necro_rod', name: 'Rod of the Pale Choir', slot: 'weapon', wtype: 'staff', rarity: 'epic', tier: 4, atk: 6, int: 7, lifesteal: 0.1, exclusive: true, tormented: 0.2, desc: 'Staff · +6 damage, +7 INT, 10% lifesteal, 20% torment. Whispers the names of the buried. (event-exclusive)', price: 360 },
  ...
  { id: 'artemis_bow', name: 'Artemis\' Moonbow', slot: 'weapon', wtype: 'bow', rarity: 'wrld', tier: 5, atk: 32, dex: 14, crit: 22, initiative: 2, dmgMult: 1.15, weaken: 0.3, poison: 0.2, desc: 'WRLD · arrows that choose their own sky. +32 dmg, +14 DEX, +22% crit, +2 initiative, +15% damage, 30% weaken, 20% poison.', price: 3100, wrld: true, noAffix: true },
  { id: 'carnwennan', name: 'Carnwennan', slot: 'weapon', wtype: 'dagger', rarity: 'wrld', tier: 5, atk: 28, dex: 12, crit: 28, lifesteal: 0.18, dmgMult: 1.12, poison: 0.35, lazy: 0.15, desc: 'WRLD · the white-hilted knife that ends arguments. +28 dmg, +12 DEX, +28% crit, 18% lifesteal, +12% damage, 35% poison, 15% lazy.', price: 3000, wrld: true, noAffix: true },
  { id: 'mjolnir', name: 'Mjölnir, the World-Hammer', slot: 'weapon', wtype: 'mace', rarity: 'wrld', tier: 5, atk: 33, str: 10, wis: 8, crit: 10, dmgMult: 1.2, frail: 0.3, stun: 0.15, desc: 'WRLD · only the worthy lift it. +33 dmg, +10 STR, +8 WIS, +10% crit, +20% damage, 30% frail, 15% stun.', price: 3150, wrld: true, noAffix: true },
  { id: 'world_fang', name: 'Worldfang', slot: 'weapon', wtype: 'axe', rarity: 'wrld', tier: 5, atk: 36, str: 14, crit: 14, dmgMult: 1.24, frail: 0.3, weaken: 0.25, desc: 'WRLD · forged from a mountain\'s last scream. +36 dmg, +14 STR, +14% crit, +24% damage, 30% frail, 25% weaken.', price: 3150, wrld: true, noAffix: true },
  { id: 'vajra', name: 'Vajra of the Still Point', slot: 'weapon', wtype: 'fist', rarity: 'wrld', tier: 5, atk: 30, dex: 12, str: 8, crit: 16, initiative: 2, dmgMult: 1.15, stun: 0.2, weaken: 0.2, desc: 'WRLD · the fist that ends storms. +30 dmg, +12 DEX, +8 STR, +16% crit, +2 initiative, +15% damage, 20% stun, 20% weaken.', price: 3000, wrld: true, noAffix: true },
];
...
export const RELICS = [
  ...
  { id: 'moon_dial', name: 'Moon Dial', rarity: 'rare', desc: 'Restore +1 class resource each combat turn. Rare clockwork.', manaRegen: 1 },
  { id: 'blood_chalice', name: 'Blood Chalice', rarity: 'uncommon', desc: 'Heal 8% max HP after every victory.', victoryHeal: 0.08 },
  { id: 'gamblers_die', name: 'Gambler\'s Die', rarity: 'rare', desc: '+10% crit chance, +5% enemy crit chance. Live a little.', crit: 10, enemyCrit: 5 },
  { id: 'golden_idol', name: 'Golden Idol', rarity: 'uncommon', desc: '+50% gold from combat.', combatGoldMult: 1.5 },
  { id: 'renown_lantern', name: 'Lantern of Renown', rarity: 'uncommon', desc: 'Your victories are witnessed — gain 1 Fame after every battle.', fameOnVictory: 1 },
