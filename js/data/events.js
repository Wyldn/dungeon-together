...
export const EVENTS = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'f9_kiln', when: { biome: 'forest', floorMin: 9, floorMax: 9, knowledge: 'rooted_court', bossPick: { floor: 10, notId: 'elderwood' } },
        append: 'The road under the roots did not lead to a court. It led to a kiln that never cooled.' },
      { id: 'f9_court', when: { biome: 'forest', floorMin: 9, floorMax: 9, knowledge: 'rooted_court' },
        append: 'The stones under the roots went downstairs. Tomorrow something holds the door. You still do not know who woke the judge.' },
      { id: 'f29_hroth', when: { biome: 'frost', floorMin: 29, floorMax: 29, knowledge: 'calvien_writ', bossPick: { floor: 30, notId: 'frost_queen' } },
        append: 'The rumor has a name now. The queen sits. The outrider fetches. Calvien\'s writ never finished standing up.' },
      { id: 'f29_court', when: { biome: 'frost', floorMin: 29, floorMax: 29, any: [
        { knowledge: 'calvien_writ' }, { knowledge: 'garden_heart' }, { knowledge: 'left_rose' },
        { flag: 'stole_rose' }, { flag: 'freed_climber' },
      ] },
        append: 'Tomorrow the court answers. You have one version of who moved first. You do not have hers.' },
      { id: 'f29_bow', when: { biome: 'frost', floorMin: 29, floorMax: 29, flag: 'kings_bowed', notFlag: 'kings_mocked' },
        append: 'You already knelt for dust. Ice has been practicing the word again.' },
      { id: 'f19_gravesend_arg', when: { biome: 'ruins', floorMin: 19, floorMax: 19, bossPick: { floor: 20, notId: 'lich' }, any: [
        { knowledge: 'tower_built' }, { flag: 'kings_petition' }, { flag: 'revenant_oath' },
      ] },
        append: 'The rumor has a name: Gravesend. Not a crown. A block. The king still files. The knight still waited. Accounting does not kneel.' },
      { id: 'f19_gravesend', when: { biome: 'ruins', floorMin: 19, floorMax: 19, bossPick: { floor: 20, notId: 'lich' } },
        append: 'The rumor says the crown is not on duty. Something that keeps names is. Kneeling will not change the ledger.' },
      { id: 'f19_archive', when: { biome: 'ruins', floorMin: 19, floorMax: 19, knowledge: 'tower_built', event: 'ghost_king' },
        append: 'The King says the tower buried them. The archive says they invited it. Tomorrow the crown itself asks which version you believed.' },
      { id: 'f19_split', when: { biome: 'ruins', floorMin: 19, floorMax: 19, flags: ['revenant_oath', 'kings_mocked'] },
        append: 'You bowed to the knight. You laughed at the king. Tomorrow the crown will notice which part of a court you respect.' },
      { id: 'f19_loyal', when: { biome: 'ruins', floorMin: 19, floorMax: 19, flags: ['revenant_oath', 'kings_bowed'] },
        append: 'You knelt twice for dust. Tomorrow the living crown — or what is left of one — asks if you meant a kingdom.' },
      { id: 'f19_petition', when: { biome: 'ruins', floorMin: 19, floorMax: 19, flag: 'kings_petition' },
        append: 'You carry a petition from a government that died centuries ago. Tomorrow a cousin wearing the crown will have an opinion about the paperwork.' },
      { id: 'f19_oath', when: { biome: 'ruins', floorMin: 19, floorMax: 19, flag: 'revenant_oath' },
        append: 'The knight waited for someone who never returned. Tomorrow the crown that never came back asks you to kneel anyway.' },
      { id: 'f19_gate', when: { biome: 'ruins', floorMin: 19, floorMax: 19 },
        append: 'Tomorrow a dust-crown asks whether this kingdom still has subjects. After that, ice. You have been practicing an answer.' },
      ...
      { id: 'origin_arcane', when: { flag: 'origin_arcane' },
        append: 'The fire reads like a diagram Immel would have hated: useful, unlabelled, slightly illegal.' },
      { id: 'guild_notes', when: { flag: 'guild_notes' },
        append: 'Margin-scrawled warnings from climbers who came back sit better next to a fire than they did in the guild hall.' },
      { id: 'undercity', when: { flag: 'undercity_ties' },
        append: 'A canal-thief\'s grin would look right in this alcove. You keep yours smaller.' },
      { id: 'lodge', when: { flag: 'lodge_mark' },
        append: 'Pell said miss once. The embers miss nothing.' },
      { id: 'guard', when: { flag: 'guard_trained' },
        append: 'You sit the way the Ninth Hall sits: back to stone, eyes on the dark.' },
      { id: 'let_it_ride', when: { flag: 'let_it_ride' },
        append: 'A book downstairs already took your whole purse on a later room. The fire does not take bets.' },
      { id: 'mentor', when: { flag: 'mentor_words' },
        append: 'Someone tapped your sternum and said the tower hasn\'t seen your ceiling. The alcove, for once, agrees.' },
      { id: 'gossip', when: { knowledge: 'dry_hall_gossip' },
        append: 'The dry hall already sold three versions of you. The fire keeps the fourth.' },
      { id: 'witness', when: { knowledge: 'petition_witnessed' },
        append: 'A clerk stamped a ghostly duplicate. The fire does not file. It waits.' },
      { id: 'thawed', when: { knowledge: 'thawed_story' },
        append: 'Someone you melted is telling people you still melt the almosts. The fire, for once, does not argue.' },
      { id: 'pale_list', when: { knowledge: 'pale_list_travels' },
        append: 'A list that curls in the heat still has a line. The fire is not a tenant.' },
      { id: 'f9_gate', when: { biome: 'forest', floorMin: 9, floorMax: 9 },
        append: 'Tomorrow the gate judges. The woods have been whispering about it since the first root.' },
      { id: 'f29_gate', when: { biome: 'frost', floorMin: 29, floorMax: 29 },
        append: 'Tomorrow someone still sitting finishes a betrayal, or refuses to. The fire does not know which.' },
    ],
    choices: [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'undercity', when: { flag: 'undercity_ties' },
        text: 'The Hooded Merchant clocks the canal-grin you never quite lost. "Undercity. I can work with that. Don\'t tell the guild I said so. Margins."' },
      { id: 'guild', when: { flag: 'guild_notes' },
        text: 'The Hooded Merchant squints at your kit like a ledger. "Guild notes. Half warnings, half apologies. I price the apologies."' },
      { id: 'lodge', when: { flag: 'lodge_mark' },
        text: 'The Hooded Merchant nods at your stance. "Lodge. Pell still sending people up with good aim and worse stories. Sit. I have arrows that forgive one miss."' },
      { id: 'academy', when: { flag: 'origin_arcane' },
        text: 'The Hooded Merchant sniffs academy dust and does not sneer. "Arcanum. I stock what the syllabus forgot. Margins love a graduate."' },
      { id: 'toll', when: { flag: 'paid_toll' },
        append: 'He heard about the hat in the woods. "A climber who pays. I could weep. I won\'t. I will, however, shave a coin."' },
      { id: 'duke', when: { flag: 'dukes_mark', biome: 'hell' },
        append: 'He clocks the stamp on your hand. "Duke\'s courtesy. I honor it. Margins remain margins."' },
    ],
    choices: [],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { label: 'Buy vitality', req: { gold: 60 }, hint: '-60g, +health',
        outcome: { text: '"Pleasure doing business." Your wounds close with the sound of a quill scratching.', gold: -60, hpPct: 0.19 } },
  ...
  },
  {
    ...
    choices: [
      { label: '"Something brave."', hint: 'inspiration + kit',
        outcome: { text: 'She plays a ballad of climbers who made it. You know it\'s statistically propaganda. It works anyway — and she tosses you a spare charm "for the encore."', hpPct: 0.08, fame: 2, itemRoll: { slot: 'accessory' } } },
  ...
  },
  {
    ...
    pace: { after: 'bard' },
    when: { flag: 'bard_friend', charAlive: 'lyra' },
  ...
  /* ---------- training / advancement ---------- */
  {
    ...
    choices: [
      ...
      { label: 'Rest on the mats', hint: 'recovery + supplies',
        outcome: { text: 'Somebody left decent bedding and a half-full kit. You honor their memory by drooling on one and taking the other.', hpPct: 0.17, consumable: 'potion_s' } },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Stand vigil a moment', hint: 'respect',
        outcome: { text: 'One minute of silence for people who bought a stranger\'s future with their own. The tower keeps a different ledger for this kind of thing.', fame: 3, hpPct: 0.04 } },
    ],
  },
  {
    id: 'frozen_library', biome: 'frost', category: 'mystery', type: 'story', glyph: '📖', w: 5,
    title: 'The Archive Under Ice',
    text: 'A library flash-frozen mid-argument: two scholars still seated across a table, ice-bound, each pointing at the other\'s page. The books are legible through the frost. One page names a claimant — Calvien, the Uncrowned. The other names a freeze that arrived before his claim could stand. A third volume, open, refuses to pick: Queen Vessalia the Unmelting, mid-betrayal, still on the throne.',
    variants: [
      { id: 'garden_empty', when: { flag: 'stole_rose' },
        text: 'A library flash-frozen mid-argument. One scholar\'s ice-bound finger now points at a new margin: THE GARDEN EXHALED. SOMEONE TOOK THE HEART. THE CLAIMANT WILL CALL IT THEFT. VESSALIA WILL NOT BE IN A RECEIVING MOOD.' },
      { id: 'garden_read', when: { knowledge: 'garden_heart', notFlag: 'stole_rose' },
        text: 'A library flash-frozen mid-argument. One scholar\'s ice-bound finger now points at a new margin: THE HEART WAS UNDERSTOOD. NOT TAKEN. THE WRIT AND THE QUEEN ARE STILL DISAGREEING ABOUT WHAT THAT MEANS.' },
      { id: 'garden_left', when: { knowledge: 'left_rose', notFlag: 'stole_rose' },
        text: 'A library flash-frozen mid-argument. A new margin, frost-fresh: THE GARDEN WAS ENTERED. THE HEART WAS LEFT. RESTRAINT, IN THIS COURT, IS ALSO A CLAIM.' },
    ],
    choices: [
      { label: 'Read the disputed pages', req: { stat: 'int', min: 12 }, hint: 'settle the argument',
        outcome: { text: 'You read both pages. One is a writ in Calvien\'s hand — the Uncrowned, claim already filed when the ice came. The other says Vessalia froze the court to stop the filing, which is a kind of mercy that looks like a crime. They were both right. That is why nothing thawed.', statUp: { stat: 'int', amt: 2 }, xp: 40, fame: 2, world: { knowledge: 'calvien_writ' } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'named', when: { knowledge: 'mira_named', notFlag: ['saved_climber', 'left_climber'] },
        text: 'A procession walks the burning floor unbothered. Their leader uses a name you heard on a broken stair: Mira. "The woods still argue about her," she says. "The slag does not. Floor fifty is Duke Malgrimm. He keeps the door. He is polite until he is not."' },
      ...
      { id: 'ride', when: { flag: 'let_it_ride' },
        append: 'One of them glances at your purse. "The book already took the whole of it. We walked past that clerk going down."' },
      { id: 'witness', when: { knowledge: 'petition_witnessed' },
        append: 'Their leader nods at your pack. "A clerk stamped a copy. The heat ate the desk. The original is still your problem."' },
    ],
    choices: [
      ...
      { label: 'Walk with them a while', hint: 'rest among the fireproof',
        outcome: { text: 'Their bell keeps the heat honest — inside its sound, the Scorch is merely warm. You walk one floor\'s length in peace and part with a blessing of soot pressed to your forehead.', hpPct: 0.08, fame: 2 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Just spar, no philosophy', hint: 'honest practice',
        outcome: { text: 'You beat the stuffing out of it for twenty minutes. Not enlightenment. Still, the body remembers.', statUpRandom: 1, hpPct: 0.08 } },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { label: 'Drink deeply and meditate', hint: 'resource + real, lasting growth',
        outcome: { text: 'The water tastes of held breath and morning. Your reserves refill; your focus narrows to something you could thread a needle with — and the edge stays.', fullMana: true, hpPct: 0.11, statUpMain: 2 } },
      ...
      { label: 'Fill a flask and move on', hint: 'safe, portable',
        outcome: { text: 'You bottle a measure of the clearwater. It sloshes in your pack, faintly luminous — a small mercy saved for later.', consumable: 'potion_s', hpPct: 0.06 } },
    ],
  },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Simply be seen here', hint: 'the recognition restores you',
        outcome: { text: 'You walk the hall of honored climbers and let the recognition sink in. It is, unexpectedly, healing.', hpPct: 0.14, fullMana: true } },
    ],
  },
    ...
    choices: [
      { label: 'Throw in a fortune (100g)', req: { gold: 100 }, hint: '-100g, generous boon',
        outcome: { roll: { stat: 'lk', dc: 8 },
          success: { text: 'The water swallows your coin and gives back interest — in power, in luck, in the feeling of being owed one by the universe.', gold: -100, statUpRandom: 2, fame: 3, hpPct: 0.14 },
    ...
    choices: [
      { label: 'Break through', hint: 'awakening',
        outcome: { roll: { stat: 'wis', dc: 9 },
          ...
          fail: { text: 'It doesn\'t tear — but it STRETCHES, and light leaks through. Not an awakening. A promise of one.', statUpRandom: 2, hpPct: 0.17, flag: 'awakening_soon' } } },
  ...
  },
  {
    ...
    choices: [
      { label: 'The lit gallery', hint: 'safe passage',
        outcome: { text: 'Lanterns the whole way, and a small shrine at the midpoint. You arrive at the rejoining arch calm and collected. You can hear the OTHER galleries\' echoes...', hpPct: 0.08, fame: 1 } },
  ...
  /* ==================== FOREST (1–10) ==================== */
  {
    ...
    choices: [
      { label: 'Spend your vitality to heal her', hint: 'costly kindness',
        outcome: { text: '"Why?" she asks, as you bind the wound. You don\'t have a good answer. "The trees have been moving toward the gate," she adds, like that is a normal sentence. "They wouldn\'t wait." She presses a spare charm into your palm before limping toward the descent gate.', hp: -25, fame: 5, flag: 'saved_climber', xp: 15, itemRoll: { slot: 'accessory' } } },
      { label: 'Give her a potion', req: { item: 'potion_s' }, hint: 'uses 1 potion',
        outcome: { text: 'She drinks, breathes, stands. "The trees have been moving toward the gate. I\'ll remember this." She trades you a better vial from her own kit — climbers\' courtesy.', useItem: 'potion_s', fame: 5, flag: 'saved_climber', xp: 15, consumable: 'potion_l' } },
  ...
  },
  {
    ...
    when: { flag: 'saved_climber', floorMin: 16, charAlive: 'mira' },
    ...
    choices: [
      ...
      { label: 'Tell her to stay below', hint: 'you climb; she lives',
        outcome: { text: '"Dinner on the surface, then. I\'ll keep the table." She still presses the bundle into your hands. The note has two addresses now — one of them is not a floor.', gold: 80, consumable: 'potion_l', fame: 5, classGear: true, world: { char: { id: 'mira', loc: 'surface', memory: 'sent_home' } } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { id: 'same_mark', when: { knowledge: 'rooted_court' },
        text: 'Bandits have barricaded the only path with a fallen log and a hand-painted sign: "TOLE: 40 GOLD." The log sits on the same court-mark you already scraped moss off of. Their leader shrugs. "Everyone\'s gotta eat, and the tower don\'t pay wages."' },
    ],
    choices: [
      { label: 'Pay the toll', req: { gold: 40 }, hint: 'safe passage',
        outcome: { text: 'The leader tips his hat. "Pleasure. Mind floor nine — the old tree that judges climbers woke up. Sylvanor. Something under the roots is still arguing. It don\'t take gold."', gold: -40, flag: 'paid_toll' } },
      { label: 'Fight them', hint: 'combat',
        outcome: { combat: { enemies: ['bandit', 'bandit'], text: 'Negotiations conclude. Steel is the universal language.' }, world: { char: { id: 'bandit_chief', met: true, rel: -2, memory: 'fought' }, faction: { id: 'bandits', rel: -2, harmed: true } } } },
      ...
      { label: 'Read the milestone', hint: 'the moss is lying',
        outcome: { text: 'A sun-crown, royal, half-eaten by moss. The trees have been burying a court, not a trail. The captain watches you read and does not lower the price.', xp: 16, world: { knowledge: 'rooted_court' } } },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { label: '"What happened to the kingdom?"', hint: 'the trees remember',
        outcome: { text: '"THE TOWER GREW THROUGH IT," the oak rumbles. "THE COURT WENT DOWNSTAIRS. THE ELDERWOOD HOLDS THE DOOR." The bark stills. You have an answer that is also a larger question.', xp: 25, world: { knowledge: 'rooted_court' } } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Name the Toll Company', req: { flag: 'paid_toll' }, hint: 'a paid debt speaks',
        outcome: { text: 'You mention the hat, the coin, the forest bridge. The alpha pauses, then files you under SOMEONE ELSE\'S PROBLEM. The eyes withdraw.', xp: 18, fame: 1, flag: 'forest_peace', clearFlag: 'angered_forest' } },
    ],
  },
  ...
  },
  {
    ...
    variants: [
      { id: 'after_king', when: { event: 'ghost_king' },
        text: 'Shelves stretch down into darkness, holding the recorded history of the fallen kingdom. Most books crumble at a touch. One — bound in silver — does not. You already heard the King Who Stayed: the tower grew through them in a night. The book looks like it disagrees.',
        choices: [
          { label: 'Decipher it', req: { stat: 'int', min: 13 }, hint: 'a scholar\'s lock',
            outcome: { text: 'The script yields. It is a confession: the kingdom BUILT the tower, and the first Demon King was its architect — a hero who reached the top and found the throne empty. That is not what the King Who Stayed told you. Someone is lying, or someone rewrote the fall, or both things were true at different hours. A margin note, later: the Lich of the Fallen King still sits the dust-throne on floor twenty, a crown with no head. Inside the cover, a silver sigil. It hums like it knows your name.\n\n✦ SIGIL OF TRUTH acquired (1 of 3)', sigil: 'truth', xp: 50, world: { knowledge: 'tower_built', counter: { id: 'curiosity', add: 1 }, tag: choiceBridgeTag('buried_library') } } },
          ...
          { label: 'Read the crumbling books instead', hint: 'gentler knowledge',
            outcome: { text: 'Tax records, love letters, a child\'s primer. A whole kingdom of ordinary days, sleeping under dust. None of them mention a ghost still filing. You climb on anyway.', xp: 45, world: { counter: { id: 'curiosity', add: 1 }, tag: choiceBridgeTag('buried_library') } } },
        ] },
    ],
    choices: [
      { label: 'Decipher it', req: { stat: 'int', min: 13 }, hint: 'a scholar\'s lock',
  ...
  },
  {
    ...
    text: 'A statue of a veiled woman cries real tears into a bronze bowl. Court-cut marble — the kind they made for someone who waited through a siege. The plaque reads: "SHE GRIEVES FOR WHAT YOU WILL LOSE." The tears glow faintly.',
    variants: [
      { id: 'court', when: { any: [{ event: 'ghost_king' }, { flag: 'revenant_oath' }, { flag: 'kings_petition' }] },
        append: 'The veil is the same cut as the fallen court. Someone stayed behind when the crown did not come home.' },
    ],
    choices: [
      ...
      { label: 'Comfort her', req: { stat: 'wis', min: 12 }, hint: 'compassion',
        outcome: { text: 'You rest a hand on the marble shoulder and tell her the truth: loss is proof there was something worth having. The weeping stops. The veil lifts a fraction — she smiles like a court that was not evacuated in time.', statUp: { stat: 'wis', amt: 1 }, xp: 25, fame: 3 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Warm yourself and move on', hint: 'rest + scrap',
        outcome: { text: 'You sit by coals that outlived a kingdom. A cooling blank on the anvil is also a kindness if you take it.', hpPct: 0.14, itemRoll: { slot: 'accessory' } } },
    ],
  },
  {
    ...
    variants: [
      { id: 'oath_archive', when: { flag: 'revenant_oath', knowledge: 'tower_built' },
        text: 'A translucent figure sits on a broken throne, crown askew. He sees the oath-dust on your knees and the silver-script still in your mouth. "My knight waited. The books say we invited the tower. I say it grew through us in a night. The line does not care which version is true. The line has not moved in six hundred years."',
        choices: [
          { label: '"He waited. Deliver the complaint anyway."', hint: 'the office, after the uniform',
            outcome: { text: '"The top," he says, pointing up. "There is always someone at the top. That is the whole problem with towers." A thinner smile. "And on twenty, a lich wearing my cousin\'s crown. Dust with opinions. Ignore him if you can." He eyes the watch still on you. "You already swore to the one who stayed. Deliver the paperwork anyway." A ghostly petition settles into your pack.', flag: 'kings_petition', xp: 35, fame: 2 } },
          { label: 'Bow to the office, not just the armor', hint: 'respect costs nothing',
      ...
      { id: 'oath', when: { flag: 'revenant_oath' },
        text: 'A translucent figure sits on a broken throne, crown askew. He sees the watch still on you. "Ah. He remained. He always remained. I filed. You knelt to the uniform. The office is still here."',
        choices: [
          { label: '"He waited. Deliver the complaint anyway."', hint: 'the office, after the uniform',
            outcome: { text: '"The top," he says, pointing up. "There is always someone at the top. That is the whole problem with towers." A thinner smile. "And on twenty, a lich wearing my cousin\'s crown. Dust with opinions. Ignore him if you can." He eyes the watch still on you. "You already swore to the one who stayed. Deliver the paperwork anyway." A ghostly petition settles into your pack.', flag: 'kings_petition', xp: 35, fame: 2 } },
          { label: 'Bow to the office, not just the armor', hint: 'respect costs nothing',
      ...
      { id: 'fought', when: { bossCleared: 15, notFlag: 'revenant_oath' },
        text: 'A translucent figure sits on a broken throne, crown askew. He looks at the ash on you. "You stood my knight up. He waited six hundred years for a king who was busy in line. I suppose that is one way to close a watch."' },
      { id: 'seen', when: { event: 'crowned_shadow', notFlag: 'revenant_oath' },
        text: 'A translucent figure sits on a broken throne, crown askew. "You walked past my knight. He is still waiting. That is his entire personality. The tower grew through us in a single night. I stayed to file a complaint. The line has not moved in six hundred years."' },
      { id: 'archive', when: { knowledge: 'tower_built' },
        text: 'A translucent figure sits on a broken throne, crown askew. He hears the confession before you speak it. "The archive prefers a prettier crime. We did not build a tomb. The tower grew through us in a single night. I stayed to file a complaint. The line has not moved in six hundred years."',
        choices: [
          { label: '"The archive says you built it."', hint: 'the books disagree',
            outcome: { text: '"Then the books were written by the ones who invited it," he says, too quickly. "I filed against the invitation. The top." He points up. "There is always someone at the top. That is the whole problem with towers." A thinner smile that does not reach the argument. "And on twenty, a lich wearing my cousin\'s crown. Dust with opinions. Ignore him if you can." He eyes you. "You\'re climbing. Deliver it for me?" A ghostly petition settles into your pack.', flag: 'kings_petition', xp: 35, fame: 2 } },
          { label: 'Bow to him anyway', hint: 'respect costs nothing',
            outcome: { text: 'It has been six centuries since anyone bowed. The king straightens his crown, stands taller, and knights you with a sword of cold light. It counts. Somehow it counts.', fame: 6, statUp: { stat: 'str', amt: 1 }, xp: 20, flag: 'kings_bowed' } },
          { label: '"Get over it, it\'s been 600 years."', hint: 'bold strategy',
            outcome: { roll: { stat: 'lk', dc: 13 },
              success: { text: 'A frozen pause. Then the king LAUGHS, a sound like church bells falling down stairs. "SIX HUNDRED YEARS and no one DARED." He flips you a spectral coin that turns real in your palm.', gold: 100, fame: 4, flag: 'kings_mocked' },
      ...
      { id: 'rooted', when: { knowledge: 'rooted_court' },
        text: 'A translucent figure sits on a broken throne, crown askew. He sees the moss still on your boots. "You found a milestone in the woods. Yes. The tower grew through us in a single night. The grove kept the door. I stayed to file a complaint. The line has not moved in six hundred years."' },
    ],
    choices: [
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Walk it like a canal roof', req: { flag: 'undercity_ties' }, hint: 'you\'ve done worse for less',
        outcome: { text: 'Muscle memory from a city that punished noise. You step where a thief would. The corridor, which has never met a canal, still respects the habit.', xp: 28, gold: 20 } },
    ],
  },
  ...
  /* ==================== FROZEN CITADEL (21–30) ==================== */
  {
    ...
    variants: [
      { id: 'court', when: { any: [
        { flag: 'stole_rose' }, { knowledge: 'garden_heart' }, { knowledge: 'left_rose' }, { knowledge: 'calvien_writ' },
      ] },
        text: 'A figure stands frozen mid-stride in a pillar of ice, hand outstretched toward the stairs up. Their mouth is shaped around a word you already met in a garden or a margin. Finish. Heart. Writ. Something the ice would not let them finish saying.',
        choices: [
          { label: 'Melt them free', hint: 'costly, uncertain',
            outcome: { roll: { stat: 'int', dc: 12 },
              success: { text: 'The ice yields to careful heat. The climber collapses, gasps a breath forty years overdue, and stares at you. "Queen Vessalia—" they rasp. "She freezes the ones who ALMOST. You already found the argument. Heart, writ — I don\'t know which is the finishing. Take my things. FINISH IT." They press their pack into your hands and stumble toward the descent.', itemRoll: true, gold: 50, fame: 5, flag: 'freed_climber' },
    ...
    choices: [
      { label: 'Melt them free', hint: 'costly, uncertain',
        outcome: { roll: { stat: 'int', dc: 12 },
          success: { text: 'The ice yields to careful heat. The climber collapses, gasps a breath forty years overdue, and stares at you. "Queen Vessalia—" they rasp. "She freezes the ones who ALMOST make it. The court almost finished something. I almost saw what. Take my things. FINISH IT." They press their pack into your hands and stumble toward the descent.', itemRoll: true, gold: 50, fame: 5, flag: 'freed_climber' },
          fail: { text: 'The ice refuses. Worse — it creaks toward YOU, and you yank your hand back just in time. The frozen climber\'s eyes, you would swear, are apologizing.', hp: -15 } } },
      { label: 'Take their gear', hint: 'they\'re not using it',
        outcome: { text: 'You chip the pack free of the ice. The frozen eyes track you. You tell yourself they don\'t. They do.', itemRoll: true, fame: -4, world: { counter: { id: 'cruelty', add: 1 }, tag: choiceBridgeTag('frozen_climber') } } },
      { label: 'Salute and move on', hint: 'respect',
  ...
  },
  {
    ...
    variants: [
      { id: 'bowed', when: { flag: 'kings_bowed', notFlag: 'kings_mocked' },
        append: 'The rose, which has no eyes, somehow notices you have knelt for a different court.' },
      { id: 'mocked', when: { flag: 'kings_mocked' },
        append: 'The silence has a sense of humor. It has heard you laugh at a crown before.' },
    ],
    choices: [
      { label: 'Study the rose', req: { stat: 'wis', min: 14 }, hint: 'deep sight',
        outcome: { text: 'You watch it without touching. The rose is a HEART — Vessalia\'s — planted here so it couldn\'t be broken twice. A frozen margin at the stem still argues: a claimant\'s name, Calvien, and a queen who would rather freeze than finish being betrayed. At its base, a frozen sigil — the second key.\n\n✦ SIGIL OF SORROW acquired (2 of 3)', sigil: 'sorrow', xp: 50, world: { knowledge: 'garden_heart' } } },
      ...
      { label: 'Leave it in peace', hint: 'some things stay',
        outcome: { text: 'Some things are beautiful because no one has taken them yet. You leave the garden exactly as you found it. The ice, which has been keeping a ledger of claims, makes a different kind of mark.', xp: 15, fame: 2, hpPct: 0.06, world: { knowledge: 'left_rose' } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { id: 'rose_read', when: { knowledge: 'garden_heart' },
        text: 'A cottage with warm windows. The note has a new line: "YOU LOOKED. YOU DID NOT TAKE IT. THAT IS ALSO A KIND OF CLAIM. THE COURT WILL TRY TO DECIDE WHICH. DO NOT BOW TO ICE THAT USED TO BE A PERSON. EAT ANYWAY." — V.' },
      { id: 'rose_left', when: { knowledge: 'left_rose' },
        text: 'A cottage with warm windows. The note has a new line: "YOU LEFT THE HEART WHERE IT WAS. RESTRAINT GETS NOTICED HERE. NOT ALWAYS KINDLY. DO NOT BOW. EAT ANYWAY." — V.' },
      { id: 'bowed', when: { flag: 'kings_bowed', notFlag: 'kings_mocked' },
        append: 'A colder line under the first: YOU ALREADY BOWED TO DUST. THIS COURT WILL COUNT IT. DO NOT DO IT AGAIN. — V.' },
      { id: 'mocked', when: { flag: 'kings_mocked' },
        append: 'A colder line: YOU LAUGHED AT A DEAD COURT. ICE HAS A SENSE OF HUMOR. IT IS NOT KIND. — V.' },
      { id: 'heron', when: { knowledge: 'heron_rumor' },
        append: 'A second scrap, smaller: HUTS THAT WALK KEEP APPOINTMENTS TOO. CHECK UNDER BELLS. — also V.' },
    ],
    choices: [
      ...
      { label: 'Eat standing, weapon drawn', hint: 'caution',
        outcome: { text: 'You eat the stew like it might be an ambush. It is delicious. Nothing attacks except the seasoning, which is aggressive in the best way.', hpPct: 0.22, manaPct: 0.4 } },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'court_read', when: { knowledge: 'garden_heart' },
        text: 'The only way forward is a narrow pass. The mountain groans like a clerk who knows you read the file. Every sound is a negotiation with a court that thinks you already picked a side.' },
      { id: 'court_left', when: { knowledge: 'left_rose' },
        text: 'The only way forward is a narrow pass. The mountain groans, then settles, as if someone who declined a claim is slightly less interesting to bury.' },
    ],
    choices: [
  ...
  /* ==================== SWAMP (31–40) ==================== */
  {
    ...
    variants: [
      ...
      { id: 'v_dinner', when: { flag: 'ate_v_dinner' },
        append: 'She sniffs. "You smell like someone else\'s stew. V still sets plates. Some of us used to be the climber. Now shoo."' },
    ],
    choices: [
  ...
  /* ==================== HELL (41–50) ==================== */
  {
    ...
    choices: [
      { label: 'Sign it', hint: 'power now, clause 7 later',
        outcome: { text: 'Power floods in like molten gold. The devil files his copy. "Clause seven activates at the throne room," he says pleasantly. "Do try to survive that long — I hate collecting early."', statUpRandom: 3, hpPct: 0.17, flag: 'clause_seven', fame: -3 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Unmake the chains with the pact', req: { class: 'warlock' }, hint: 'borrowed dawn, spent honestly',
        outcome: { text: 'The chains were not made for a signature. You spend the clause sideways. Light stands, six-winged, and looks at you like a contract that finally found a loophole it likes. "The King asks every hero one question," it says. "Answer it HONESTLY. That is the entire secret." A feather remains — burning, weightless.', item: 'phoenix_feather', fame: 8, xp: 60, flag: 'freed_angel' } },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Show the feather', req: { flag: 'freed_angel' }, hint: 'the choir argues about you',
        outcome: { text: 'The knight stares at the light in your pack. Eight eyes blink out of sequence. "The chained one flew. Pass." The wretches are yanked aside like a theological dispute.', xp: 22, fame: 2 } },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'vigil_ride', when: { flag: 'let_it_ride' },
        append: 'A book downstairs already took your whole purse on this room. The match does not take bets.' },
      { id: 'vigil_pilgrim', when: { flag: 'pilgrim_lore' },
        append: 'The ash-walkers said he was fair. Fair is not kind. The candles know the difference.' },
      { id: 'vigil_evener', when: { flag: 'evener_met' },
        append: 'The masked one said the tower deals from the bottom. These wicks were dealt the same way.' },
      { id: 'vigil_network', when: { knowledge: 'v_network' },
        append: 'The witch and the cottage both left food out. This room leaves a match.' },
      { id: 'vigil_mentor', when: { flag: 'mentor_words' },
        append: 'Someone said the tower hasn\'t seen your ceiling. The candles have seen every ceiling. They still let you sit.' },
    ],
    choices: [
  ...
  },
  {
    ...
    onSee: { char: { id: 'channeler', met: true, memory: 'first_meeting' } },
  ...
  },
  {
    ...
    onSee: { char: { id: 'pathfinder', met: true, memory: 'first_meeting' } },
    title: 'The Pathfinder Veteran',
    text: 'A ranger leans against a trail-marker that shouldn\'t exist indoors. "Talk trails, duel to test your aim, or keep walking," they say. "I\'ve mapped worse."',
    ...
    choices: [
      ...
      { label: 'Duel to test your aim', hint: 'hard fight — better spoils + XP',
  ...
  },
  {
    ...
    onSee: { char: { id: 'northman', met: true, memory: 'first_meeting' } },
  ...
  },
  {
    ...
    onSee: { char: { id: 'revenant', met: true, loc: 'ruins', memory: 'seen' } },
    ...
    variants: [
      { id: 'petition', when: { flag: 'kings_petition' },
        text: 'You find a kneeling silhouette ahead — greatsword planted, crown fused to helm. The petition in your pack goes cold. He does not look up. He does not need to. "That handwriting. He filed. I waited. You may carry the office to the dust on twenty, or you may swear to the one who stayed."',
        choices: [
          { label: 'Kneel and swear to the knight who waited', hint: 'the king filed; this is the watch',
            outcome: { text: 'He does not rise. The petition stays in your pack, unanswered. The oath is older than the paperwork.', fame: 4, hpPct: 0.08, flag: 'revenant_oath', xp: 40 } },
          ...
          { label: 'Keep the petition and leave him kneeling', hint: 'the office, not the uniform',
            outcome: { text: 'You keep the complaint and give the crown a wide berth. Floor 15 will remember which claim you chose.', xp: 28 } },
        ] },
      { id: 'mocked', when: { flag: 'kings_mocked' },
        text: 'You find a kneeling silhouette ahead — greatsword planted, crown fused to helm. The crown on the helm ticks, once. "You laughed at him. He is still my king. Do not swear a joke to me."',
        choices: [
          { label: 'Kneel anyway — to the watch, not the joke', hint: 'the oath will not be funny',
            outcome: { text: 'He does not rise. Something cold accepts your words anyway, and files the laugh separately.', fame: 4, hpPct: 0.08, flag: 'revenant_oath', xp: 40 } },
          { label: 'Wake him now', hint: 'DEADLY — face the Crowned Revenant early',
            outcome: { combat: { enemies: ['crowned_revenant'], text: 'He stands up for you. Early.',
              xp: 85, gold: [70, 110],
              reward: { chooseLabel: 'Dust settles. Take one:', options: [
      ...
      { id: 'bowed', when: { flag: 'kings_bowed', notFlag: 'kings_mocked' },
        text: 'You find a kneeling silhouette ahead — greatsword planted, crown fused to helm. He smells courtesy on you. "You bowed to the office. The office did not come back. I am still here. Do not kneel unless you mean a different king."',
        choices: [
          { label: 'Kneel and swear a temporary oath', hint: 'the watch, after the office',
            outcome: { text: 'He does not rise. Something cold accepts your words anyway. Two kneels, two claims. The dust keeps both.', fame: 4, hpPct: 0.08, flag: 'revenant_oath', xp: 40 } },
          { label: 'Wake him now', hint: 'DEADLY — face the Crowned Revenant early',
            outcome: { combat: { enemies: ['crowned_revenant'], text: 'He stands up for you. Early.',
              xp: 85, gold: [70, 110],
              reward: { chooseLabel: 'Dust settles. Take one:', options: [
    ...
    choices: [
      { label: 'Kneel and swear a temporary oath', hint: 'blessing + fame — refuse a harder road later?',
        outcome: { text: 'He does not rise. Something cold accepts your words anyway.', fame: 4, hpPct: 0.08, flag: 'revenant_oath', xp: 40 } },
      { label: 'Wake him now', hint: 'DEADLY — face the Crowned Revenant early',
        outcome: { combat: { enemies: ['crowned_revenant'], text: 'He stands up for you. Early.',
          xp: 85, gold: [70, 110],
          reward: { chooseLabel: 'Dust settles. Take one:', options: [
  ...
  },
  {
    ...
    variants: [
      { id: 'forest_mark', when: { biome: 'forest', floorMax: 7, knowledge: 'rooted_court' },
        text: 'Two travelers share a cold meal on the stair. One of them points at the same court-mark you already scraped moss off of. "See? Kingdom-stone. Trees ate the road after the court died." The other disagrees. "The old tree at the gate woke up to judge because the kings stopped. Sylvanor. It don\'t take gold."' },
      { id: 'forest_talk', when: { biome: 'forest', floorMax: 7 },
        text: 'Two travelers share a cold meal on the stair. One nods at the roots. "Used to be a road. Kingdom-stone. Trees ate it after the court went under." The other shakes her head. "No. The trees are doing the judging the kings stopped doing. That\'s why the old tree at the gate woke up."' },
    ],
  ...
  },
  {
    ...
    text: 'An old man sits where the stair widens, cane across his knees. His eyes are kind. His shadow is not. "Face me," he offers, "ask how strong I think you are, or ask if I still teach."',
    npc: { art: 'oldman_gentle', name: 'The Old Man', blurb: 'Kind eyes. Unkind secrets. Three offers — only one is a fight.' },
    choices: [
      { label: 'Test your skills in a fight', hint: 'secret fight — easy OR boss-tier',
        outcome: {
      ...
      { label: 'Ask for teachings', hint: 'more growth, partial mend, XP',
        outcome: { text: 'He teaches without standing. Your bones rearrange their opinions — wounds only half-listen.',
          statUpRandom: 4, hpPct: 0.19, fullMana: true, xp: 55 } },
    ],
  },
];
