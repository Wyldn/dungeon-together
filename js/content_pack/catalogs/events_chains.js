...
PACK_EVENTS.push(...chain('cp_gate_inward', '🚪', [
  ...
  },
  {
    ...
    when: { any: [{ flag: 'cp_inward_touched' }, { flag: 'cp_inward_gate_mapped' }, { flag: 'cp_inward_refused' }] },
    choices: [
  ...
  },
  {
    ...
    choices: [
      ...
      idChoice({ class: 'priest' }, 'Cleanse them', 'Fame, stable gate', { fame: 3, flag: 'cp_gate_stable', resolveCurse: ['regen_poison', 'parasite_return'] }),
...
PACK_EVENTS.push(...chain('cp_returned_extra', '👤', [
  {
    ...
    choices: [
      walk('Give them a potion and let them follow', 'companion flag', { useItem: 'potion_s', flag: 'cp_seventh_followed', flag2: 'cp_seventh_met' }, { req: { item: 'potion_s' } }),
      walk('Demand payment', '+30g, their resentment', { gold: 30, flag: 'cp_seventh_resented', flag2: 'cp_seventh_met' }),
      walk('Ask the System to identify them', '[UNREGISTERED PROTAGONIST]', { flag: 'cp_seventh_unregistered', flag2: 'cp_seventh_met', world: { knowledge: 'cp_unregistered_protagonist' } }),
      walk('Leave them behind', 'abandonment', { flag: 'cp_seventh_abandoned', flag2: 'cp_seventh_met', fame: -2 }),
      idChoice({ race: 'human' }, 'Recognize adaptability in their selection', 'kinship', { flag: 'cp_seventh_followed', flag2: 'cp_seventh_met', fame: 1 }),
      idChoice({ class: 'bard' }, 'Recover a verse that named seven', 'the hymn had a seventh line', { flag: 'cp_seventh_unregistered', flag2: 'cp_seventh_met', fame: 2 }),
      idChoice({ class: 'necromancer' }, 'Test whether they are fully alive', 'neither, and both', { flag: 'cp_seventh_unregistered', flag2: 'cp_seventh_met', world: { knowledge: 'cp_seventh_liminal' } }),
      idChoice({ class: 'priest' }, 'Restore their ceremonial name', 'a name returns', { fame: -2, flag: 'cp_seventh_named', flag2: 'cp_seventh_met' }),
      idChoice({ class: 'rogue' }, 'Find the receipt for six purchased rankings', 'evidence', { flag: 'cp_seventh_unregistered', flag2: 'cp_seventh_met', gold: 15 }),
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      walk('Restore their name', 'trade Fame for a party blessing', { fame: -5, flag: 'cp_seventh_restored', item: 'cp_seventh_nameplate', resolveCurse: 'fame_inverse' }),
