...
chain('cp_drowned_royals', '👑', [
  ...
  { id: 'cp_court_beneath_bog', biome: 'swamp', flag: 'cp_successor',
    ...
    when: { any: [{ flag: 'cp_statue_restored' }, { flag: 'cp_crypt_looted' }, { flag: 'cp_genealogy' }, { flag: 'cp_bloodline_fake' }, { flag: 'cp_older_claim' }, { flag: 'cp_claimant_paid' }] },
    choices: [
      ...
      w('Claim the title', 'you', { flag: 'cp_chose_self', flag2: 'royalClaimant', item: 'cp_royal_claimant_mantle' }),
      ...
      w('Refuse monarchy', 'popular Fame', { fame: 5, flag: 'cp_refused_monarchy', resolveCurse: ['royal_aggro', 'elite_attract', 'heal_penalty'] }),
      w('Wear the drowned court\'s dress and take the minutes', 'cursed silk', { item: 'cp_drowned_court_dress', flag: 'cp_court_dressed' }),
  ...
  { id: 'cp_king_waiting_hell', biome: 'hell', flag: 'cp_royal_closed',
    ...
    when: { any: [{ flag: 'cp_chose_princess' }, { flag: 'cp_chose_swamp' }, { flag: 'cp_chose_self' }, { flag: 'cp_crown_melted' }, { flag: 'cp_refused_monarchy' }, { flag: 'cp_court_dressed' }, { flag: 'cp_trial_rule' }, { flag: 'cp_song_claim' }, { flag: 'cp_rites_invalid' }, { flag: 'cp_seal_filed' }] },
    choices: [
      w('Defend the decision', 'stand by it', { fame: 2, flag: 'cp_decision_defended' }),
      w('Return the crown', 'abdication', { flag: 'cp_crown_returned', resolveCurse: 'royal_aggro' }),
      w('Accept the drowned bride\'s rapier as a wedding gift', 'a second hit waits', { item: 'cp_drowned_brides_rapier', flag: 'cp_bride_steel' }),
...
chain('cp_gate_mason', '🧱', [
  ...
  { id: 'cp_bridge_from_doors', biome: 'frost', flag: 'cp_bridge',
    ...
    when: { any: [{ flag: 'cp_mason_map' }, { flag: 'cp_mason_helped' }, { flag: 'cp_repair_token' }, { flag: 'cp_mocked_mason' }, { flag: 'cp_mason_tunnels' }, { flag: 'cp_portal_only' }, { flag: 'cp_both_necessary' }] },
    choices: [
  ...
  { id: 'cp_last_gate_inspection', biome: 'hell', flag: 'cp_mason_closed',
    ...
    choices: [
      w('Help certify a safe escape gate', 'honest work', { fame: 4, flag: 'cp_safe_cert', resolveCurse: 'biome_locked' }),
      ...
      w('Take the final gate uniform he will not wear', 'biome-locked plate', { item: 'cp_final_gate_uniform', flag: 'cp_uniform_taken' }),
    ] },
]);
...
chain('cp_ashen_rivals', '🔥', [
  ...
  { id: 'cp_rivals_missing_member', biome: 'ruins', flag: 'cp_rival_missing',
    ...
    when: { any: [{ flag: 'cp_rival_trust' }, { flag: 'cp_rival_gambled' }, { flag: 'cp_rival_boast' }, { flag: 'cp_rival_stolen' }, { flag: 'cp_rival_duel' }, { flag: 'cp_rival_contest' }, { flag: 'cp_rival_secret' }, { flag: 'cp_rival_ideology' }] },
    choices: [
  ...
  { id: 'cp_rankings_split_us', biome: 'frost', flag: 'cp_rival_split',
    ...
    when: { any: [{ flag: 'cp_rival_rescued' }, { flag: 'cp_rival_recruited' }, { flag: 'cp_rival_ransomed' }, { flag: 'cp_rival_concealed' }, { flag: 'cp_rival_dead_member' }] },
    choices: [
...
PACK_EVENTS.push(
  ...
  stand('cp_grave_tax', 'ruins', 'Grave-Tax Collector', 'The dead claim every living person owes interest.', [
    ...
    w('Buy a funeral receipt', 'paper that the dead still honor', { gold: -20, consumable: 'cp_funeral_receipt' }, { req: { gold: 20 } }),
    w('Take the collector\'s dagger as collateral', 'a cursed receipt in steel', { item: 'cp_funeral_receipt_dagger', flag: 'cp_tax_steel' }),
    idc({ class: 'priest' }, 'Invoke burial law', 'the collector blinks', { fame: 2, flag: 'cp_burial_law', resolveCurse: ['summon_gold_tax', 'gold_for_healing_cut'] }),
