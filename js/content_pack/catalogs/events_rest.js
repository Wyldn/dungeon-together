...
chain('cp_gate_beast_egg', '🥚', [
  ...
  { id: 'cp_egg_chooses_class', biome: 'ruins', flag: 'cp_egg_trained',
    ...
    when: { any: [{ flag: 'cp_egg_carried' }, { flag: 'cp_egg_fed' }] },
    choices: [
...
chain('cp_seven_owners', '🗡️', [
  ...
  { id: 'cp_fourth_owner_betrayer', biome: 'frost', flag: 'cp_blade_betrayer',
    ...
    when: { any: [{ flag: 'cp_blade_held' }, { flag: 'cp_coward_memory' }] },
    choices: [
  ...
  { id: 'cp_sixth_owner_you', biome: 'swamp', flag: 'cp_blade_future',
    ...
    choices: [
      ...
      w('Reject it', 'weaker, uncursed', { flag: 'cp_blade_rejected' }),
  ...
  { id: 'cp_seventh_owner', biome: 'hell', flag: 'cp_blade_closed',
    ...
    choices: [
      ...
      w('Free all previous owners', 'defensive relic', { item: 'cp_empty_saint_icon', flag: 'cp_owners_freed' }),
...
chain('cp_false_system', '💻', [
  { id: 'cp_optional_mandatory', biome: 'forest', flag: 'cp_quest_window',
    ...
    choices: [
      ...
      idc({ class: 'mage' }, 'Inspect its underlying script', 'corruption mapped', { flag: 'cp_script_read', world: { knowledge: 'cp_false_script' } }),
  ...
  { id: 'cp_terms_have_changed', biome: 'swamp', flag: 'cp_terms',
    ...
    when: { any: [{ flag: 'cp_obeyed_false' }, { flag: 'cp_system_dissident' }, { flag: 'cp_script_read' }, { flag: 'cp_quest_redirected' }, { flag: 'cp_terms_read' }] },
    choices: [
  ...
  { id: 'cp_customer_support_boss', biome: 'hell', flag: 'cp_support_closed',
    ...
    when: { any: [{ flag: 'cp_terms_hp' }, { flag: 'cp_terms_fame' }, { flag: 'cp_future_obligation' }, { flag: 'cp_terms_public' }] },
    choices: [
      w('File an appeal using accumulated evidence', 'if you gathered flags, it works', { flag: 'cp_appeal_filed', item: 'cp_redacted_support_ticket' }),
...
chain('cp_futures_merchant', '🔮', [
  { id: 'cp_buy_something_you_might_need', biome: 'forest', flag: 'cp_future_bought',
    ...
    choices: [
      ...
      idc({ race: 'dragonkin' }, 'Collateralize part of the hoard', 'gold pledged', { gold: -25, flag: 'cp_pred_hoard' }),
    ] },
  { id: 'cp_futures_market', biome: 'frost', flag: 'cp_future_sold',
    ...
    when: { any: [{ flag: 'cp_pred_danger' }, { flag: 'cp_pred_potion' }, { flag: 'cp_pred_gear' }, { flag: 'cp_pred_free' }, { flag: 'cp_pred_memory' }] },
    choices: [
  ...
  { id: 'cp_settlement_day', biome: 'hell', flag: 'cp_future_closed',
    ...
    when: { any: [{ flag: 'cp_sold_chest' }, { flag: 'cp_sold_fame' }, { flag: 'cp_locked_slot' }, { flag: 'cp_bought_back' }, { flag: 'cp_shorted' }] },
    choices: [
      w('Honor the contract', 'paid in full', { flag: 'cp_honored' }),
...
chain('cp_fame_eater', '⭐', [
  ...
  { id: 'cp_nobody_remembers', biome: 'swamp', flag: 'cp_obscure',
    ...
    when: { any: [{ flag: 'cp_eater_potion' }, { flag: 'cp_eater_id' }, { flag: 'cp_eater_gold' }, { flag: 'cp_eater_tamed' }, { flag: 'cp_eater_caught' }] },
    choices: [
  ...
  { id: 'cp_most_famous_meal', biome: 'hell', flag: 'cp_eater_closed',
    ...
    choices: [
      ...
      w('Kill it and recover part of the Fame', 'partial refund', { fame: 4, combat: { enemies: ['shade'] }, flag: 'cp_eater_killed' }),
