...
export const PACK_ARMOR_FOUNDATION = [
  gear({ id: 'cp_gate_surveyor_coat', name: "Gate Surveyor's Coat", slot: 'chest', rarity: 'common', tier: 1, def: 2, packOrdinary: true,
  ...
  gear({ id: 'cp_bog_wader_boots', name: 'Bog-Wader Boots', slot: 'boots', rarity: 'common', tier: 1, def: 1, packOrdinary: true,
  ...
  gear({ id: 'cp_gate_iron_helm', name: 'Gate-Iron Helm', slot: 'helmet', rarity: 'common', tier: 1, def: 2, packOrdinary: true,
  ...
  gear({ id: 'cp_quiet_step_greaves', name: 'Quiet-Step Greaves', slot: 'legs', rarity: 'common', tier: 1, def: 1, dodge: 3, packOrdinary: true,
...
export const PACK_ARMOR_CURSED = [
  ...
  gear({ id: 'cp_the_empty_seat', name: 'The Empty Seat', slot: 'chest', rarity: 'epic', tier: 4, def: 4, acquisition: 'cursed', curse: 'missing_allies',
    resolution: 'Bell of the Last Companion.',
    desc: 'Cursed · stronger for each downed or eliminated ally; weaker in a healthy party. Never uses disconnect.',
    playable: 'adapted', adaptation: 'Counts authoritative downed/eliminated allies only.',
    effects: [ef('beforeDamageTaken', 'modIncoming', { missingAllies: true, add: 0.08, mult: 1 })] }),
