...
- **Vercel (HTTPS):** the game talks `wss://<host>/api/party`, a same-origin WebSocket proxy that forwards to the party server. Co-op works without mixed-content blocks.
